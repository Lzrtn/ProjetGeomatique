...
WMSFlow::WMSFlow(int crs, string  str_north, string str_south, string str_east, string str_west,
...
void WMSFlow::getImage()
    {
    std::remove("../src/data/dowloaded_images/wms_images/downloaded_wms_image.jpeg");
    // Initialize libcurl
    ...
    if (curl) {
        ...
        std::ofstream imageFile("../src/data/dowloaded_images/wms_images/downloaded_wms_image.jpeg", std::ios::binary);
...
string WMSFlow::getPath() {
        return "../src/data/dowloaded_images/wms_images/downloaded_wms_image.jpeg";
    }
