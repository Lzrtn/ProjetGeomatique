...
WMTSFlow::WMTSFlow(int tilematrix, double west_limit, double north_limit, int width, int height, int epsg)
/*
*
...
*/
{
    ...
    string str_east  = to_string(east_limit)WMTS;*/
...
void WMTSFlow::setURL(const char* newurl){
    this.url = newurl;
}

vector<vector<const char*>> WMTSFlow::getUrl() {
